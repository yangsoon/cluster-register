...
func main() {
	...
	flag.StringVar(&spokeKubeSecretName, "name", "", "secret name which store the spoke-cluster kubeconfig")
	flag.StringVar(&spokeKubeSecretNS, "namespace", "", "secret namespce")
	flag.Parse()
